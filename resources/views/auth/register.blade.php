<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-gray-600 mt-1">Join Daily~Track to manage your activities</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div class="space-y-3 pt-2">
            ...
            <div class="text-center text-sm text-gray-600">
                ...
                <a href="{{ route('login') }}" class="font-medium text-nss-green-600 hover:text-nss-green-700">
                    Sign in
                </a>
            </div>
        </div>
